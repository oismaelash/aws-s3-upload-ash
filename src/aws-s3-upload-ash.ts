...
class ReactS3Client {
  ...
  public async uploadFile(file: File, contentType: string, presignedURL?: string, newFileName?: string, acl?: string): Promise<any> {
    ...
    if (presignedURL) {
      ...
      const aclFinal = acl === null || acl === undefined || acl === "" ? "public-read" : acl
      fd.append("key", key);
